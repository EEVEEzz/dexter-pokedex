...
// Get the path to the directory containing your main script (main.js)
const appPath = app.getAppPath()

// Define the relative path within your project
const relativePath = '/' // Adjust this to your file's location
...
ipcMain.handle('url', () => absolutePath)
